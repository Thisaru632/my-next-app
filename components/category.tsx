...
const SERVICES: ServiceData[] = [
  { id: "1", title: "Airport Transfers", desc: "Seamless door-to-airport journeys with comfort and punctuality. Our professional drivers ensure you never miss a flight, with real-time tracking and immaculate vehicles standing by.", passion: "Seamless", bgImage: "/service/airport.jpg", icon: PlaneIcon },
  { id: "2", title: "City Tours", desc: "Discover the vibrant heart of the city with expert local guides. From ancient temples to bustling markets, immerse yourself in the culture, history and hidden gems of Sri Lanka's finest cities.", passion: "Vibrant", bgImage: "/service/city.jpg", icon: BuildingIcon },
  { id: "3", title: "Island Tours", desc: "Enchanting escapes across breathtaking islands and hidden beaches. Explore pristine coastlines, turquoise lagoons, and secluded coves found only with a trusted local guide by your side.", passion: "Enchanting", bgImage: "/service/island.jpg", icon: CompassIcon },
  { id: "4", title: "Corporate Travel", desc: "Professional, efficient, and tailored business travel solutions. From executive airport transfers to full conference logistics, we handle every detail so your team can focus on what matters.", passion: "Professional", bgImage: "/service/coparate.jpg", icon: BriefcaseIcon },
  { id: "5", title: "Wedding & Events", desc: "Magical moments crafted with elegance and unforgettable detail. Let us curate luxurious transportation and bespoke event travel that makes your special day truly extraordinary.", passion: "Magical", bgImage: "/service/wedding.jpg", icon: HeartIcon },
  { id: "6", title: "Long Distance", desc: "Exploring far horizons with comfort, safety, and style. Whether crossing the island or journeying to remote highland retreats, our long-distance service keeps you relaxed every mile of the way.", passion: "Exploring", bgImage: "/service/long_distance.jpg", icon: MapPinIcon },
];
