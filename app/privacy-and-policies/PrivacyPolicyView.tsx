...
interface PrivacyPolicyViewProps {
  initialTab: 'driver' | 'customer';
}

export default function PrivacyPolicyView({ initialTab }: PrivacyPolicyViewProps) {
  const router = useRouter();
  const [activeTab, setActiveTab] = useState<'driver' | 'customer'>(initialTab);
